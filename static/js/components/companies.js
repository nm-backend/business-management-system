...
class CompaniesComponent {
    ...
    renderSubscription(modal, data) {
        ...
        panel.innerHTML = `
            <div class="list-group u-card-flat-alt u-mb-4">
                <div class="list-row u-cursor-default">
            ...
            ${pendingInvoices.length ? `
                ...
                <div class="list-group u-card-flat-alt u-mb-4">
                    ${pendingInvoices.map((i) => `
                        <div class="list-row u-cursor-pointer" data-confirm-invoice="${i.id}">
                            <span class="text-sm">#${i.id} · ${i.amount} ${i.currency} <span class="badge badge-progress" data-i18n="subscription.pending"></span></span>
                            <span class="text-sm font-bold u-primary-text" data-i18n="subscription.confirm_payment"></span>
                        </div>`).join('')}
                </div>` : ''}
        `;
        window.i18n.applyTranslations();
