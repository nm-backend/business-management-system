/**
 * Минималистичные SVG-иконки (стиль Lucide/Tabler): один размер, одна толщина,
 * currentColor. Заменяют эмодзи в навигации, статистике и уведомлениях.
 *
 * Использование:
 *   window.icon('home')                       -> строка <svg>
 *   <span data-icon="home"></span> + renderIcons()  -> вставит svg
 */
(function () {
    const P = {
        ...
        wallet: '<path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4"/><path d="M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4"/><path d="M18 12a2 2 0 0 0 0 4h3v-4z"/>',
        ...
        /* ── HIG-набор: замена эмодзи в компонентах ── */
    ...
    window.icon = function (name, size) {
        ...
        return `<svg class="lucide" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${body}</svg>`;
    };

    window.renderIcons = function (root) {
        (root || document).querySelectorAll('[data-icon]').forEach((el) => {
            if (el.dataset.iconDone) return;
            el.innerHTML = window.icon(el.dataset.icon, el.dataset.iconSize ? Number(el.dataset.iconSize) : 20);
