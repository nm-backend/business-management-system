...
class ClientViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsOwnerOrAdmin]  # Работник клиентов не видит
...
class PaymentViewSet(viewsets.ModelViewSet):
    queryset = Payment.objects.select_related('client', 'order', 'received_by')
    serializer_class = PaymentSerializer
    permission_classes = [IsOwner]  # Суммы оплат видит только владелец
