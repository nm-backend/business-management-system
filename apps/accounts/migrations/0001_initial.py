    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('owner', 'Egasi'), ('admin', 'Administrator'), ('worker', 'Ishchi')], db_index=True, default='worker', max_length=10)),
                ...
                ('language', models.CharField(choices=[('uz_cyrl', 'Ўзбекча'), ('ru', 'Русский')], default='uz_cyrl', max_length=10)),
