...
>
> **Redis ҲАМ КЕРАК ЭМАС** (фақат ишлаб чиқаришда — production'да керак бўлади).
> Реал вақтли чат (WebSocket) dev'да ўзи ишлайди: `runserver` ASGI-серверни
> (Daphne) автоматик кўтаради. Барча кутубхоналар `requirements.txt`да бор.
...
> 💬 **Чат (реал вақтли).** «Хабарлар» бўлимига кириб «Чат» вкладкасини оч —
> «Умумий чат» кўринади, хабар ёзиб юбор. WebSocket ўзи уланади (алоҳида буйруқ
> шарт эмас). Текшириш: браузер DevTools → Network → WS да `/ws/chat/` уланиши.
